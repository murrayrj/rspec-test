...
def select_elements_starting_with_a(array)
  array.select{|fruit| fruit =~ /^a/}
end

# keep only the elements that start with a vowel
def select_elements_starting_with_vowel(array)
  array.select{|name| name[0] == name[/[aeiou]/]}
end
...
def get_first_half_of_string(string)
  ...
  string.length.odd? ? string[0..half] : string[0..half-1]
end
...
def number_of_elements_that_are_palindromes(array)
  palindromes = array.select{|word| word if word == word.reverse}
  palindromes.length
end
...
def get_all_letters_in_array_of_words(array)
  [array[0].split(''), array[1].split(''), array[2].split('')].flatten.sort
end
